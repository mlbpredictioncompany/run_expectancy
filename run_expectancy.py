...
# CLEAN OUTPUT
runs_expected = runs_expected.loc[runs_expected['runs_expected'] > 0].reset_index()
runs_expected[['outs', 'runner_1b', 'runner_2b', 'runner_3b']] = np.array(runs_expected['game_state'].apply(lambda x: np.array(x.split('-'))).to_list()).astype(int)
print(runs_expected)
